    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type', models.CharField(choices=[('PR', 'Pribadi'), ('PE', 'Perusahaan')], default='PR', max_length=2)),
                ...
                ('account_provider', models.CharField(choices=[('NO', 'Normal'), ('GO', 'Google'), ('BO', 'Both')], default='NO', max_length=2, null=True)),
                ('role', models.CharField(choices=[('AD', 'Admin'), ('US', 'User'), ('SU', 'Superuser')], default='US', max_length=2)),
        ...
        migrations.CreateModel(
            name='CompanyAccount',
            fields=[
                ('id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='authentication.user')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('occupancy_info', models.CharField(blank=True, max_length=64)),
